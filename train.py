...
from Models import segnet, squeezed_segnet, fcn, squeezed_fcn, segnet_depool, tiny_segnet_depool, very_squeezed_fcn, very_squeezed_segnet, very_tiny_segnet_depool
import numpy as np
...
if __name__ == '__main__':
    ...
    if para.model_type == "very_squeezed_segnet":
        print('Initialising Super Squeezed Segnet. Very few parameters ...')
        model, output_rows, output_cols = very_squeezed_segnet.squeezed_SegNet()
    ...
    if para.model_type == "very_tiny_segnet_depool":
        print('Initialising Very Tiny Segnet with Max Pooling Indices...')
        model, output_rows, output_cols = very_tiny_segnet_depool.SegNet()
    ...
    if para.model_type == "very_squeezed_fcn":
        print('Initialising Super Squeezed FCN...')
        model, output_rows, output_cols = very_squeezed_fcn.fcn_8()

...
def fcn_8(input_shape=(para.img_cols, para.img_rows, para.channels), classes=para.num_classes, input_tensor=None):
    ...
    #   Block 5
    o = y4
    o = (Conv2D(classes, (1, 1), padding='same', name='block5_conv1'))(o)
    #o = Conv2DTranspose(classes, kernel_size=(4, 4), strides=(2, 2), use_bias=False, name='block5_convTrans1')(o)

    #   Block 6
    o2 = y3
    o2 = (Conv2D(classes, (1, 1), padding='same', name='block6_conv1'))(o2)
    o, o2 = crop(o, o2, img_input)
    o = Add()([o, o2])
    o = UpSampling2D(size=(2, 2))(o)
    #o = Conv2DTranspose(classes, kernel_size=(4, 4), strides=(2, 2), use_bias=False, name='block6_convTrans1')(o)
    ...
    o = Add()([o2, o])
    o = UpSampling2D(size=(2, 2))(o)
    #o = Conv2DTranspose(classes, kernel_size=(8, 8), strides=(2, 2), use_bias=False, name='block7_convTrans1')(o)
